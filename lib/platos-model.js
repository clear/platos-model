...
Platos.create = function (name, collection) {
	...
	*/
	Model.prototype.save = function () {
		//Slight hack to indicate no save functionality should be performed if last argument is undefined
		//(this is done so we can force 'save' hooks to run from insert())
		if (arguments.length === 0 || _.last(arguments) !== undefined) {
